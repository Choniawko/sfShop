...
use AppBundle\Entity\CommentVote;
 ...
 class CommentsController extends Controller
 {
     ...
     /**
      * @Route("/komentarze/glosuj-up/{id}", name="comment_up_vote")
      */
     public function upVoteAction(Comment $comment, Request $request)
     {
     ...
     /**
      *  @Route("/komentarze/glosuj-down/{id}", name="comment_down_vote")
      */
     public function downVoteAction(Comment $comment, Request $request)
     {
            $commentVote = $this->getDoctrine()
                ->getRepository('AppBundle:CommentVote')
                ->findOneBy([
